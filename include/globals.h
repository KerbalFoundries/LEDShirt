...
#define ACCEL_PRIORITY         tskIDLE_PRIORITY+1
...
// specify the audio system config like how many band channels.
    ...
    #define ENABLE_TEMP_DEBUG       0
    
    #define DEFAULT_EFFECT_INTERVAL     (60*60*24)

    #define MAX_BUFFERS     20
   
    #define LED_PIN0        26  //33 for straight
    #define NUM_CHANNELS    1
    ...
    #define ROLLING_AVERAGE_ALPHA         0.5f
    #define ROLLING_MOVEMENT_ALPHA          0.5f
    #define MOVEMENT_SQUELCH        0.1f
