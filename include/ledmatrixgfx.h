...
public:
  ...
  //takes floats as postiions and calcs brightness to give illusion of fractional
  inline void setPixelsSmooth(float fPos, float count, CRGB c, bool bMerge = false) const
	{		
