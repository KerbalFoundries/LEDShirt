...
*/
    ...
    //new VUFlame("Sound Flame 2", VUFlame::MULTICOLOR),
    ...
    //new PaletteFlameEffect("Smooth Purple Fire", PurpleColors_p),
    ...
    //new VUFlame("Sound Flame Red", VUFlame::REDX),
    //new VUFlame("Sound Flame Blue", VUFlame::BLUEX),
    //new VUFlame("Sound Flame Green", VUFlame::GREENX),
    
    new SpectrumAnalyzerEffect("Spectrum Fade", spectrumBasicColors, 0, 70, 1.0, 1.0, true),
    //new IanColorBeat("IanColorBeat",0.25,1.25,0.075),
    new VUFlame("Music Flame Multi", VUFlame::MULTICOLOR, VUFlame::MUSIC),
    new VUFlameEffect("Multicolor Sound Flame", VUFlameEffect::MULTICOLOR),
    new VUFlame("Dance Flame Multi", VUFlame::MULTICOLOR, VUFlame::ACCEL),
    new InsulatorSpectrumEffect("InsulatorSpectrumEffect", RainbowColors_p),
